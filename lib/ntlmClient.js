...
function NtlmClient(credentials, AxiosConfig) {
    ...
    client.interceptors.response.use(function (response) {
        ...
        var error, wwwAuthenticateHeader, t1Msg, parsedT1Message, t2Msg, t3Msg, stream_1;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    console.log("request headers", (_a = error === null || error === void 0 ? void 0 : error.request) === null || _a === void 0 ? void 0 : _a.headers);
                    console.log((_b = error === null || error === void 0 ? void 0 : error.request) === null || _b === void 0 ? void 0 : _b.toJSON());
                    ...
                    if (wwwAuthenticateHeader.length < 50) {
                        ...
                        parsedT1Message = ((_c = wwwAuthenticateHeader === null || wwwAuthenticateHeader === void 0 ? void 0 : wwwAuthenticateHeader.match(/^NTLM\s+(.+?)(,|\s+|$)/)) === null || _c === void 0 ? void 0 : _c[1]) || "";
                    ...
                    stream_1 = (_d = err.response) === null || _d === void 0 ? void 0 : _d.data;
