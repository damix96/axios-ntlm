...
var antlm = __importStar(require("./alternative_ntlm"));
...
function NtlmClient(credentials, AxiosConfig) {
    ...
    client.interceptors.response.use(function (response) {
        ...
        var error, wwwAuthenticateHeader, t1Msg, at1Msg, parsedT1Message, t2Msg, at2Msg, t3Msg, at3Msg, stream_1;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    error = err.response;
                    wwwAuthenticateHeader = error === null || error === void 0 ? void 0 : error.headers["www-authenticate"];
                    console.log("request headers", error === null || error === void 0 ? void 0 : error.request.getHeaders(), "shka", error === null || error === void 0 ? void 0 : error.request.shouldKeepAlive, "kat", error === null || error === void 0 ? void 0 : error.request._keepAliveTimeout, "agent", error === null || error === void 0 ? void 0 : error.request.agent, "data", error === null || error === void 0 ? void 0 : error.data);
                    console.log(Object.keys(error === null || error === void 0 ? void 0 : error.request));
                    if (!((error === null || error === void 0 ? void 0 : error.status) === 401 && wwwAuthenticateHeader.includes("NTLM"))) return [3 /*break*/, 3];
                    ...
                    if (wwwAuthenticateHeader.length < 50) {
                        ...
                        at1Msg = antlm.createType1Message(credentials);
                        console.log("T1 message created.", t1Msg, "Alt:", at1Msg);
                        error.config.headers["Authorization"] = t1Msg;
                    }
                    else {
                        console.log("Length is >= 50; Decoding T2 message");
                        parsedT1Message = ((_a = wwwAuthenticateHeader === null || wwwAuthenticateHeader === void 0 ? void 0 : wwwAuthenticateHeader.match(/^NTLM\s+(.+?)(,|\s+|$)/)) === null || _a === void 0 ? void 0 : _a[1]) || "";
                        t2Msg = ntlm.decodeType2Message(parsedT1Message);
                        at2Msg = antlm.parseType2Message(wwwAuthenticateHeader);
                        console.log("T2 Decoded", t2Msg, "Alt:", at2Msg, "Creating T3 message");
                        t3Msg = ntlm.createType3Message(t2Msg, credentials.username, credentials.password, credentials.workstation, credentials.domain);
                        at3Msg = antlm.createType3Message(at2Msg, credentials);
