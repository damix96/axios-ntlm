...
function createType1Message(workstation, target) {
    ...
    pos += 4;
    //flags
    buf.writeUInt32LE(flags.NTLMFLAG_NEGOTIATE_DOMAIN_SUPPLIED |
        flags.NTLMFLAG_NEGOTIATE_WORKSTATION_SUPPLIED |
        flags.NTLMFLAG_NEGOTIATE_56 |
        flags.NTLMFLAG_NEGOTIATE_128 |
...
function createType3Message(type2Message, username, password, workstation, target) {
    ...
    buf.writeUInt16LE(type2Message.encoding === "ascii"
        ? workstation.length
        : workstation.length * 2, 44);
    buf.writeUInt16LE(type2Message.encoding === "ascii"
        ? workstation.length
        : workstation.length * 2, 46);
